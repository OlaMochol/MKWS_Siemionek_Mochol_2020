...
oneatm = 100000;
%zmienne do podania
p_ox=200*oneatm; %cisnienie utleniacza w zbiorniku atm
d_ox=1/1; %srednica wtrysku utleniacza w mm
p_cham=150*oneatm; %cisnienie w komorze spalania w atm
T0=298; %temperatura poczatkowowa w K
p_e=oneatm; %cisnienie na wylocie z dyszy

%zmienne wystepujace w kodzie
M_ful=32.045; % masa molowa paliwa w g/mol
...
h_ful=-2977063; % entalpia twozenia  w J/kg
...
for ii=o_f(1):h:o_f(2)
    dm_ful=dm_ox/ii;
    if ii<2.75
        % a1*N2h4 + a2*N2O -> a3*H2O + a4*NH3 + a5*N2 + a6*H2
        c=1;
        a=zeros(1,6);
        ...
        a(3)=a(2);
        a(4)=(4*a(1)-2*a(3))/3;
        a(5)=(2*a(1)+2*a(2)-2*a(4))/2;
        a(6)=0;
        dm_n2h4=a(1)*32.045/1000;
        ...
        % a1*N2h4 + a2*N2O -> a3*H2O + a5*N2 + a4*N2O
        c=2;
        a=zeros(1,5);
        a(1)=dm_ful*1000/M_ful;
        a(2)=dm_ox*1000/M_ox;
